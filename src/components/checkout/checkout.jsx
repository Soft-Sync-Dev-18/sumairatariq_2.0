...
export function Checkout() {
    ...
    await API.getAllMultipleProducts(payload)
      .then((res) => {
        ...
        Object.keys(cart)?.map((e, i) => {
          ...
          obj2.push({ Quantity: cart[e]?.quantity, ...filter[0] });
        });
  ...
  function onSubmit(values) {
    ...
    if (!isCheckedTerm) setError("plz accept terms and condition");
    if (user?.id) {
        ...
        <div className="bg-slate-100 rounded-[5px] md:px-10 px-4  py-5">
          ...
          <div className="py-5">
            ...
            <div className="p-4 bg-white w-full text-sm text-gray-700 my-5">
              Pay with cash upon delivery. We use Leopards for nationwide
              delivery.
            </div>
            ...
            <div className="py-4">
              <div className="flex items-center gap-2 mb-1">
                <input
                  ...
                  className="text-xs w-3 h-3 rounded-[4px] text-gray-600"
                />
                <p className="text-sm ">
